...
const StorybookWork = () => {
  ...
  const data = useStaticQuery(graphql`
    query {
      ...
      pages: file(relativePath: {eq: "portfolio/storybook/gallery/storybook-component-list.png"}) {
        childImageSharp {
      ...
      interactive: file(relativePath: {eq: "portfolio/storybook/gallery/storybook-modal-component.png"}) {
        childImageSharp {
          fluid(maxWidth: 610, quality: 100) {
            ...GatsbyImageSharpFluid
          }
      ...
      navigation: file(relativePath: {eq: "portfolio/storybook/gallery/storybook-component-chart.png"}) {
        childImageSharp {
          fluid(maxWidth: 610, quality: 100) {
            ...GatsbyImageSharpFluid
          }
      ...
      logos: file(relativePath: {eq: "portfolio/storybook/gallery/storybook-other-components.png"}) {
        childImageSharp {
          fluid(maxWidth: 610, quality: 100) {
            ...GatsbyImageSharpFluid
          }
          ...
          <div className="grid grid-left grid-details">
            ...
            <div className="grid-text">
              <div className="list">
                <h4>Details</h4>
                <ul>
                  <li><FaCalendarAlt/><strong>Date:</strong><span>&nbsp;February, 2021</span></li>
                  <li><FaTag/><strong>Category:</strong><span>&nbsp;Development</span></li>
                  <li><FaTools /><strong>Tool:</strong><span>&nbsp;Storybook</span></li>
                </ul>
              </div>
              ...
              <div className="list">
                ...
                <ul>
                  <li><FaArrowRight/>Creating Components from Xolo's CSS</li>
                </ul>
              </div>
            </div>
          </div>
